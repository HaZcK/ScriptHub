...
if isMobile then
    ...
    local JOY_R = 90 -- radius deteksi zone joystick (lebih besar biar mudah kena di HP)

    local function isInJoyZone(pos)
        -- Joystick ada di pojok kiri bawah
        local screenSize = workspace.CurrentCamera.ViewportSize
        local joyScreenX = 20 + 70  -- left offset + half width
        local joyScreenY = screenSize.Y - 170 + 70  -- bottom offset + half height
        local c = Vector2.new(joyScreenX, joyScreenY)
